    ...
    <Modal title="ใบเสร็จ / สรุปออเดอร์" onClose={onClose}>
      <div style={{
        background: r.receiptBgDataUrl
          ? `linear-gradient(165deg, rgba(251,247,236,0.72) 0%, rgba(251,247,236,0.92) 100%), url(${r.receiptBgDataUrl})`
          : THEME.bg,
        ...
        {r.proofImageDataUrl && (
          <div style={{ marginBottom: 14 }}>
            ...
            <img src={r.proofImageDataUrl} alt="รูปภาพกิจกรรม" style={{ width: "100%", maxHeight: 380, objectFit: "contain", borderRadius: 12, border: `1px solid ${THEME.border}`, background: THEME.card, display: "block" }} />
          </div>
        )}
