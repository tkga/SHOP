...
import { genId, fmtMoney, fmtDate, clamp0, uniquePokemonNames } from "../utils.js";
      ...
      {isSell && (
        <>
          ...
          <div className="pgs-field">
            ...
            <VariantChips value={form.pokemonVariants} onChange={(v) => set("pokemonVariants", v)} variants={data.pokemonVariants} disabled={!!form.stockItemId} />
            {form.stockItemId && (
