...
export async function downloadReceiptImage(order, data, custName, accName) {
  ...
  // background — solid cream fill, always. A busy photo behind the text (the old dark-theme
  // behaviour) fights with this document-style layout and washes out the low-contrast text/badges,
  // so the "แนบรูปพื้นหลังใบเสร็จ" setting is intentionally not used here anymore.
