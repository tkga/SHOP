...
const SHEETS = {
  ...
  stock: { title: "Stock", headers: ["ชื่อไอดี", "ชื่อสินค้า (Pokémon)", "ชนิด", "จำนวนคงเหลือ", "แจ้งเตือนเมื่อเหลือ ≤", "รูปสินค้า", "ลิงก์รูป (ห้ามลบ)", "ราคาต่อตัว"] },
...
function driveImageFormula(fileId) {
  ...
  // replacement. sz=w1000 asks for a reasonably large image so it isn't blurry
  // once IMAGE() scales it down to 76x76.
